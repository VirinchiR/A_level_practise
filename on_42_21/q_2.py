class Picture:
    def __init__(self, DescriptionP,WidthSizeP,HeightSizeP,FrameColorP):
        self. __Descripiton = DescriptionP
        self .__Width = int(WidthSizeP)
        self .__Height = int(HeightSizeP)
        self .__FrameColor = FrameColorP
